...
| Y-02 | Evaluate ELA cases and document false positives | Ayana | CLAIMED | `ayana/ela-validation` | Evaluation assets/scripts and `docs/FORENSICS_EVALUATION.md`; coordinate before production ELA edits | 2026-09-18 | Claimed by Ayana; implementation not started |
